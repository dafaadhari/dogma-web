                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('topics.update', $topic->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="date" id="date" value="{{ \Carbon\Carbon::parse($topic->discussion_date)->format('Y-m-d') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>
